        ...
        <div className='w-full'>
          ...
          <div className={`overflow-hidden transition-all duration-300 ${isOpenUser ? 'max-h-[100px]' : 'max-h-0'}`}>
            <Link to='/admin/list-user'>
              <div
                className={`flex justify-between pl-4 pr-2 mr-2 ml-15 h-[45px] mb-1 mt-1 rounded-xl cursor-pointer hover:bg-blue-100 ripple ${path === ListUserPath ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-100 text-blue-900'}`}
              >
                <div className='flex items-center gap-[14px]'>
                  ...
                  <p className='text-[15px]'>{t('user_list')}</p>
                </div>
              </div>
            </Link>
            <Link to='/admin/add-user'>
              ...
              >
                <div className='flex items-center gap-[14px]'>
                  ...
                  <p className='text-[15px]'>{t('add_user')}</p>
                </div>
              </div>
            </Link>
          </div>
          ...
          >
            <div className='flex justify-center items-center gap-x-[14px]'>
              ...
              <p className='text-[15px]'>{t('service')}</p>
            </div>
            ...
            <Link to='/admin/setting-fee-electricity'>
              ...
              >
                <div className='flex items-center gap-[3px]'>
                  <svg xmlns='http://www.w3.org/2000/svg' width='37' height='34' viewBox='0 0 24 20'>
                    <path
                      fill='currentColor'
                      fillRule='evenodd'
                  ...
                  <p className='text-[15px]'>{t('electricity_fee')}</p>
                </div>
              </div>
            </Link>
            <Link to='/admin/setting-fee-water'>
              ...
              >
                <div className='flex items-center gap-[11px]'>
                  ...
                  <p className='text-[15px]'>{t('water_fee')}</p>
                </div>
              </div>
            </Link>
          ...
          >
            <div className='flex justify-center items-center gap-[8px]'>
              ...
              <p className='text-[15px]'>{t('apartment')}</p>
            </div>
            ...
            <Link to='/admin/list-apartment'>
              ...
              >
                <div className='flex items-center gap-[11px]'>
                  ...
                  <p className='text-[15px]'>{t('apartment_list')}</p>
                </div>
              </div>
            </Link>
            <Link to='/admin/add-apartment'>
              ...
              >
                <div className='flex items-center gap-[15px]'>
                  ...
                  <p className='text-[15px]'>{t('add_apartment')}</p>
                </div>
              </div>
            </Link>
          </div>
