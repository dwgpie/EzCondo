      ...
      <div className='w-full font-semibold flex flex-col items-center'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <div className='relative group'>
            {/* Nút bấm */}
            <div
              className={`flex justify-between px-[15px] py-2 mt-1 h-[80px] rounded-xl cursor-pointer hover:bg-blue-100 ripple ${path === ElectricMeterPath || path === ElectricicReadingPath || path === ElectricUnpaidPath ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-100'}`}
              style={
                i18n.language === 'vi'
                  ? {
                      padding: '0 26px'
            ...
            {/* Hover Menu */}
            <div className='hover-menu' style={{ width: '230px' }}>
              <ul>
          ...
          <div className='relative group'>
            {/* Nút bấm */}
            <div
              className={`flex justify-between px-[9px] py-2 mt-1 h-[80px] rounded-xl cursor-pointer hover:bg-blue-100 ripple ${path === HistoryNotificationPath || path === AddNotificationPath ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-100'}`}
              style={
                i18n.language === 'vi'
                  ? {
                      padding: '0 14px'
