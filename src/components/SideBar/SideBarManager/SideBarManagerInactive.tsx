...
export default function SideBarManagerInactive() {
  ...
  const { t, i18n } = useTranslation('sidebarmanager')
  const [menuPosition, setMenuPosition] = useState({ top: 0, left: 0 })
  const [isUserActive, setIsUserActive] = useState(false)
  const [isElectricActive, setIsElectricActive] = useState(false)
  ...
  const parkingMenuTimer = useRef<NodeJS.Timeout | null>(null)
  const incidentMenuTimer = useRef<NodeJS.Timeout | null>(null)
  const notificationMenuTimer = useRef<NodeJS.Timeout | null>(null)
  const transactionMenuTimer = useRef<NodeJS.Timeout | null>(null)
  ...
  return (
    <div className='flex flex-col items-center bg-blue-50 mb-10 w-full h-screen border-r-2 border-[#eaeaea] text-blue-900 relative'>
      ...
      <div className='w-full font-semibold flex flex-col items-center custom-scroll '>
        {/* Dashboard */}
        <p
        ...
        <div className='flex flex-col items-center'>
          ...
          <div
            ...
            onMouseLeave={() => {
              userMenuTimer.current = setTimeout(() => setIsUserActive(false), 100)
            }}
          ...
          <div
            onMouseEnter={(e) => {
              handleMouseEnter(e.currentTarget)
              if (electricMenuTimer.current) clearTimeout(electricMenuTimer.current)
              setIsElectricActive(true)
            }}
            onMouseLeave={() => {
              electricMenuTimer.current = setTimeout(() => setIsElectricActive(false), 100)
            }}
            className={`flex justify-between px-[13.5px] py-2 mt-1 h-[80px] rounded-xl cursor-pointer hover:bg-blue-100 ripple ${path === ElectricMeterPath || path === ElectricicReadingPath || path === ElectricUnpaidPath ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-100'}`}
            style={
              i18n.language === 'vi'
                ? {
                    padding: '0 25px'
          ...
          >
            <div className='flex flex-col justify-center items-center text-center gap-[2px]'>
              ...
              <p className='text-[13px]'>{t('electricity')}</p>
            </div>
          </div>
          ...
          <div
            onMouseEnter={(e) => {
              handleMouseEnter(e.currentTarget)
              if (waterMenuTimer.current) clearTimeout(waterMenuTimer.current)
              setIsWaterActive(true)
            }}
            onMouseLeave={() => {
              waterMenuTimer.current = setTimeout(() => setIsWaterActive(false), 100)
            }}
            className={`flex justify-between px-[26px] py-2 mt-1 h-[80px] rounded-xl cursor-pointer hover:bg-blue-100 ripple ${path === WaterMeterPath || path === WaterReadingPath || path === WaterUnpaidPath ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-100'}`}
            style={
              i18n.language === 'vi'
                ? {
                    padding: '0 28px'
          ...
          >
            <div className='flex flex-col justify-center items-center text-center gap-[2px]'>
              ...
              <p className='text-[13px]'>{t('water')}</p>
            </div>
          </div>
          ...
          <div
            onMouseEnter={(e) => {
              handleMouseEnter(e.currentTarget)
              if (parkingMenuTimer.current) clearTimeout(parkingMenuTimer.current)
          ...
          >
            <div className='flex flex-col justify-center items-center text-center gap-[2px]'>
              ...
              <p className='text-[13px]'>{t('parking')}</p>
            </div>
          </div>
          ...
          <div
            ...
            className={`flex justify-center px-[19px] py-2 mt-1 h-[80px] rounded-xl cursor-pointer hover:bg-blue-100 ripple ${path === ListIncidentPath ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-100'}`}
            style={
              i18n.language === 'vi'
                ? {
                    padding: '0 27px'
          ...
          >
            <div className='flex flex-col justify-center items-center text-center gap-[2px]'>
              ...
              <p className='text-[13px]'>{t('incident')}</p>
            </div>
          </div>
          ...
          <div
            onMouseEnter={(e) => {
              handleMouseEnter(e.currentTarget)
              if (notificationMenuTimer.current) clearTimeout(notificationMenuTimer.current)
              setIsNotificationActive(true)
            }}
            onMouseLeave={() => {
              notificationMenuTimer.current = setTimeout(() => setIsNotificationActive(false), 100)
            }}
            className={`flex justify-center px-[7px] py-2 mt-1 h-[80px] rounded-xl cursor-pointer hover:bg-blue-100 ripple ${path === HistoryNotificationPath || path === AddNotificationPath ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-100'}`}
            style={
              i18n.language === 'vi'
                ? {
                    padding: '0 12px'
          ...
          <div
            onMouseEnter={(e) => {
              handleMouseEnter(e.currentTarget)
              if (transactionMenuTimer.current) clearTimeout(transactionMenuTimer.current)
            ...
            <Link to='/manager/list-resident'>
              ...
              >
                <div className='flex items-center gap-[10px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[10px]'>{t('resident_list')}</li>
                </div>
              </div>
            </Link>
          </ul>
            ...
            <Link to='/manager/add-electricity-meter'>
              ...
              >
                <div className='flex items-center gap-[6px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[10px]'>{t('electricity_meter')}</li>
                </div>
              </div>
            </Link>
            <Link to='/manager/add-electricity-reading'>
              ...
              >
                <div className='flex items-center gap-[10px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[8px] '>{t('electricity_reading')}</li>
                </div>
              </div>
            </Link>
            <Link to='/manager/unpaid-electricity'>
              ...
              >
                <div className='flex items-center gap-[10px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[10px] '>{t('unpaid_electricity')}</li>
                </div>
              </div>
            </Link>
          </ul>
            ...
            <Link to='/manager/add-water-meter'>
              ...
              >
                <div className='flex items-center gap-[6px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[10px]'>{t('water_meter')}</li>
                </div>
              </div>
            </Link>
            <Link to='/manager/add-water-reading'>
              ...
              >
                <div className='flex items-center gap-[10px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[8px] '>{t('water_reading')}</li>
                </div>
              </div>
            </Link>
            <Link to='/manager/unpaid-water'>
              ...
              >
                <div className='flex items-center gap-[9px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[10px] '>{t('unpaid_water')}</li>
                </div>
              </div>
            </Link>
          </ul>
            ...
            <Link to='/manager/list-parking'>
              ...
              >
                <div className='flex items-center gap-[10px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[10px]'>{t('parking_list')}</li>
                </div>
              </div>
            </Link>
            ...
            <Link to='/manager/list-incident'>
              ...
              >
                <div className='flex items-center gap-[10px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[10px]'>{t('incident_list')}</li>
                </div>
              </div>
            </Link>
          </ul>
            ...
            <Link to='/manager/payment-history'>
              ...
              >
                <div className='flex items-center gap-[10px]'>
                  ...
                  <li className='flex items-center h-[30px] pl-[10px]'>{t('payment_history')}</li>
                </div>
              </div>
            </Link>
